...
parser.add_argument('--output_path', default='../dup_image_result/result_non_transfer.json', help='The output path stores repeated images list, each of which is a list that stores a group of duplicated images. Default it will be current_path/duplicated_images.json')
