...
parser.add_argument('--input_path', default="../to_test_file", help='The file path of an image or an image directory.')

parser.add_argument('--img_base_path', default="../phash/phash_index.txt", help='The file path stores the phash index of image base')
...
parser.add_argument('--output_path', default='../dup_image_result/result.json', help='The output result is a json file in which stores the duplicated images of input_path in img_base_path. '
